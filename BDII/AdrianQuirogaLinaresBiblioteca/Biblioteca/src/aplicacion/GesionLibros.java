...
public class GesionLibros{
    ...
    public List<Ejemplar> actualizarEjemplaresLibro(Integer libro, java.util.List<Ejemplar> ejemplares, java.util.List<Integer> borrar){
       ...
       for (Ejemplar e:ejemplares){
           if (e.getNumEjemplar()==null) fbd.insertarEjemplarLibro(libro, e);
           else fbd.modificarEjemplarLibro(libro, e);
       }
       
       fbd.borrarEjemplaresLibro(libro, borrar);

       return fbd.consultarEjemplaresLibro(libro);
    }
}
