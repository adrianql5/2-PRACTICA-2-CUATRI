...
public class VLibro extends javax.swing.JDialog {
     ...
     private boolean botonActualizarPulsado=false;
     private boolean botonDevolverPulsado=false;
     private boolean botonPrestarPulsado=false;
     private boolean botonBorrarPulsado=false;
    ...
    public VLibro(java.awt.Frame parent, boolean modal, aplicacion.FachadaAplicacion fa, Libro libro, java.util.List<String> categorias, java.util.List<String> restoCategorias) {
        ...
        mTEjemplares.setFilas(libro.getEjemplares(), fa.obtenerUsuarios(null, null));

        // Desactivar botones desde el inicio
        ...
        this.ejemplaresBorrados = new java.util.ArrayList<>();
    }
            ...
            .addGroup(panelGeneralAutoresLayout.createSequentialGroup()
                ...
                .addGroup(panelGeneralAutoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelGeneralAutoresLayout.createSequentialGroup()
                        ...
                        .addComponent(textoTitulo, javax.swing.GroupLayout.DEFAULT_SIZE, 427, Short.MAX_VALUE))
                    .addGroup(panelGeneralAutoresLayout.createSequentialGroup()
                    ...
                    .addGroup(panelGeneralAutoresLayout.createSequentialGroup()
                        ...
                        .addGroup(panelGeneralAutoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelGeneralAutoresLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(textoNuevoAutor, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE))
    ...
    private void btnNuevoEjemplarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoEjemplarActionPerformed
        ...
        prestarButton.setEnabled(false);
        devolverButton.setEnabled(false);
        btnNuevoEjemplar.setEnabled(false);
        btnBorrarEjemplar.setEnabled(false);
    ...
    private void btnActualizarEjemplaresLibroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarEjemplaresLibroActionPerformed
        ...
        if (botonNuevoPulsado && botonBorrarPulsado) {
            btnNuevoEjemplar.setEnabled(true);
        } else if (botonNuevoPulsado && botonActualizarPulsado) {
            btnBorrarEjemplar.setEnabled(true);
            prestarButton.setEnabled(true);
        } else if (botonNuevoPulsado || botonBorrarPulsado) {
            btnNuevoEjemplar.setEnabled(true);
        } else if (botonPrestarPulsado) {
            btnActualizarEjemplaresLibro.setEnabled(true);
        } else {
            btnNuevoEjemplar.setEnabled(false);
            btnBorrarEjemplar.setEnabled(false);
        ...
        botonActualizarPulsado = true;
        botonBorrarPulsado = false;
        botonNuevoPulsado = false;
        botonPrestarPulsado = false;
        
        java.util.List<Ejemplar> ejemplares;
        ModeloTablaEjemplares me= (ModeloTablaEjemplares)tablaEjemplares.getModel();
        ejemplares=fa.actualizarEjemplaresLibro(idLibro, me.getFilasEjemplares(), ejemplaresBorrados);
        
        Libro l=fa.consultarLibro(idLibro);
        
        me.setFilas(l.getEjemplares(),fa.obtenerUsuarios(null,null));
        if (me.getRowCount()>0) {
    ...
    private void prestarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_prestarButtonActionPerformed
        ...
        Ejemplar ejemplarSeleccionado = ((ModeloTablaEjemplares) tablaEjemplares.getModel()).obtenerEjemplar(selectedRow);
        fa.prestar(ejemplarSeleccionado);
        
        btnNuevoEjemplar.setEnabled(false);
        btnBorrarEjemplar.setEnabled(false);
        btnActualizarEjemplaresLibro.setEnabled(true);
        devolverButton.setEnabled(true);
        botonPrestarPulsado = true;
    ...
    private void devolverButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_devolverButtonActionPerformed
        ...
        int selectedRow = tablaEjemplares.getSelectedRow();
        Ejemplar ejemplarSeleccionado = ((ModeloTablaEjemplares) tablaEjemplares.getModel()).obtenerEjemplar(selectedRow);
        Usuario usuarioSeleccionado = ((ModeloTablaEjemplares) tablaEjemplares.getModel()).obtenerUsuario(selectedRow);
        
        fa.devolverEjemplar(usuarioSeleccionado,ejemplarSeleccionado);
        ModeloTablaEjemplares me= (ModeloTablaEjemplares)tablaEjemplares.getModel();
        java.util.List<Ejemplar> ejemplares;
        ejemplares=fa.actualizarEjemplaresLibro(idLibro, me.getFilasEjemplares(), ejemplaresBorrados);
    ...
    private void tablaEjemplaresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaEjemplaresMouseClicked
        ModeloTablaEjemplares me = (ModeloTablaEjemplares) tablaEjemplares.getModel();
        Ejemplar ejemplarSeleccionado = me.obtenerEjemplar(tablaEjemplares.getSelectedRow());
        Usuario dueño = null;

        // Validar si el ejemplar tiene un libro antes de comprobar el estado de préstamo
        if (ejemplarSeleccionado.getLibro() != null) {
            
            dueño = ejemplarSeleccionado.estaPrestado(fa.obtenerUsuarios(null, null));

            if(botonBorrarPulsado){
                devolverButton.setEnabled(false);
                prestarButton.setEnabled(false);
            }
            
            // Manejar lógica de préstamo/devolución
            else if (dueño != null) { 
                devolverButton.setEnabled(true);
                prestarButton.setEnabled(false);
                btnBorrarEjemplar.setEnabled(false);
