#version 330 core  // Usamos la versión 3.30 de GLSL, compatible con OpenGL 3.3

// Atributos de entrada del vértice
layout(location = 0) in vec3 aPos;        // Posición del vértice (x, y, z)
layout(location = 1) in vec3 aNormal;     // Normal del vértice (para iluminación)
layout(location = 2) in vec2 aTextCoord;  // Coordenadas de textura (u, v)
